/**
 * GET /api/v1/hoc-nghe/progress/:groupId
 * Get user's progress for a specific Học Nghề course
 *
 * PATCH /api/v1/hoc-nghe/progress/:groupId
 * Update user's progress for a specific Học Nghề course
 */

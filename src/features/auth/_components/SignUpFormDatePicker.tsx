...
function SignUpFormDatePicker<T extends FieldValues = FieldValues>({
    label,
    name,
    placeholder,
    required = false,
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <Controller
                ...
                control={control}
                render={({ field }) => {
                    // Display string if provided, else format Date to dd/mm/yyyy
                    let stringValue = "";
...
export default SignUpFormDatePicker;

...
export const InstructionsCard = () => {
    return (
        <div className="hidden sm:block mb-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-5 border border-green-100">
            <div className="flex items-start gap-3">
                <div className="bg-green-500 rounded-xl p-2.5 flex-shrink-0">

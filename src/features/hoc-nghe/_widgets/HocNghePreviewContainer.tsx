...
interface HocNghePreviewContainerProps {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl py-8">
                ...
                <div className="space-y-4">
                    ...
                    <CourseContentCard
                        ...
                        description="Xem các video lý thuyết để hiểu rõ về học nghe"
                        step="01"
                    >
                    ...
                    <CourseContentCard
                        ...
                        description="Xem các video thực hành để hiểu rõ về học nghe"
                        step="02"
                    >
